...
The workflow is trigger after an identity is created. The workflow will simply ask the manager about the computer and mobile phone to be assigned to the joiner. Then, tickets are automatically opened in ServiceNow
